...
\fntext[fn1]{Submitted to ``Information Processing and Management".}

\address[lancs]{Lancaster University, Lancaster, LA1 4YW, UK}
\address[usfd]{University of Sheffield, Sheffield, S1 4DP, UK}
...
\begin{keyword}
entity diffusion \sep information diffusion \sep named entity recognition \sep social computing
\end{keyword}
...
We found that having a volume of in-genre unsupervised data could be used to much greater effect than approximations from blended corpora.
...
Tools that Dr. Derczynski has worked on are in daily use at many large enterprises, including Intel and CSIRO, and he frequently serves in an advisory role on social media, natural language processing and information retrieval.
