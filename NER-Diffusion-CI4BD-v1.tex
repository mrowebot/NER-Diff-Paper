...
\begin{enumerate}
	...
	\item \textbf{RQ3:} How can we predict the spresd o named entities and who will begin talking about them?	
\end{enumerate}
...
Named entity recognition has been a long-recognised NLP task, the earliest major instances of which are perhaps the ACE and MUC challenges.
...
Subreddits can be found in the github repository of this work \url{https://github.com/mattroweshow/NER-Diff-Paper}
...
Model & \multicolumn{2}{c |}{Static} & \multicolumn{2}{c}{Discrete-Time} \\
