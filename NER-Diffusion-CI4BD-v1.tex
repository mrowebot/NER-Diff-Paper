...
%Therefore we take the cluster identifier at every level, tracing the provenance of a terminal word cluster all the way to the root cluster (which contains all word types).
...
%The properties files for these runs are included in github repository.\footnote{\url{https://github.com/hidden-for-review}}
